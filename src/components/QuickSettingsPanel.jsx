    ...
    <>
      ...
      >
        <button
          ...
          aria-label={localIsOpen ? '关闭设置面板' : '打开设置面板'}
        >
          {localIsOpen ? (
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className={`flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-6 bg-white dark:bg-gray-900 ${isMobile ? 'pb-20' : ''}`}>
            ...
            {/* View Options */}
            <div className="space-y-2">
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">视图选项</h4>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 ml-3">
                启用后，按 Ctrl+Enter 发送消息,而不是直接按 Enter 键。这对输入法用户很有用,可以避免意外发送。
              </p>
            </div>

            {/* Whisper Dictation Settings - HIDDEN */}
            <div className="space-y-2" style={{ display: 'none' }}>
              <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">语音听写</h4>
